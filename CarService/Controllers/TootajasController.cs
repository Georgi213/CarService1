...
namespace CarService.Controllers
{
    public class TootajasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TootajaID,Nimi,Vanus,email,Telefon,haridus")] Tootaja tootaja)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TootajaID,Nimi,Vanus,email,Telefon,haridus")] Tootaja tootaja)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Tootaja'  is null.");
            }
            var tootaja = await _context.Tootaja.FindAsync(id);
            if (tootaja != null)
            {
